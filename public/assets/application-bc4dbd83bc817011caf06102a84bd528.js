    ...
    $('#today_btn').click(function() {
        if (is_next_seven) {
            ...
            setTimeout(function() {
                ...
                $('.today').addClass('col-xs-6');
                $('.today').addClass('text-center col-xs-offset-3');
            }, 200);
    ...
    $('#next_seven_btn').click(function() {
        if (!is_next_seven) {
            ...
            setTimeout(function() {
                ...
                $('.today').removeClass('col-xs-6');
                $('.today').addClass('col-xs-3');
                $('.today').removeClass('text-center col-xs-offset-3');
            }, 200);
            $('#task-header').fadeOut(200, function() {
...
$(document).ready(function() {
    ...
    $('.exclamation').click(function() {
        // exclamationId = $(this).attr('id');
        // console.log(exclamationId);
    ...
    // sprites = $('.sprites').attr('data-sprites');
    // console.log('.exclamation' + sprites);
    // toggleOpacity($('#exclamation' + sprites));
...
function toggleOpacity(dom) {
    dom.click(function() {
        console.log("in here");
        dom.toggleClass('opacity_full');
    });
}
;
// just messing around with ajax
// $(document).ready(function () {
//   $(function () {
//     $('#hope').click(function(){
//       //alert("hey");
